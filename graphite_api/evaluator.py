...
def pathsFromTokens(requestContext, tokens, replacements=None, consolidateBy=None):
    iters = []
    ...
    if tokens.template:
        ...
        iters.append(pathsFromTokens(requestContext, tokens.template, arglist, consolidateBy))

    elif tokens.expression:
        iters.append(pathsFromTokens(requestContext, tokens.expression,
                                     replacements, consolidateBy))
        ...
        iters.append([(expression, consolidateBy)])
        ...
        iters.extend([pathsFromTokens(requestContext, arg, replacements, consolidateBy)
