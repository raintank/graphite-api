...
${BUILD_DIR}/usr/share/python/graphite/bin/pip install ${REPO_PREFIX}/graphite-kairosdb.git@${KAIROADB_BRANCH}
...
${BUILD_DIR}/usr/share/python/graphite/bin/pip install cassandra-driver
